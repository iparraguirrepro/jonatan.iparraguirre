          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              <BlurFadeText
                ...
                yOffset={8}
                text={`Hola, soy ${DATA.name.split(" ")[0].toLowerCase()} 👋`}
              />
              <BlurFadeText
      ...
      <section id="skills">
        ...
        {/* <div className="flex min-h-0 flex-col gap-y-3 mt-4">
          <BlurFade delay={BLUR_FADE_DELAY * 7}>
            <h2 className="text-sm font-bold">Mis participaciones:</h2>
          </BlurFade>
          <div className="flex flex-wrap gap-1">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 10}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                Durante mi experiencia he participado de proyectos con gran alcance y un alto impacto.
                </p>
              </div>
            </div>
          </BlurFade>
        ...
        <div className="grid items-center justify-center gap-4 px-4 text-center md:px-6 w-full py-12">
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                ¿Buscas un desarrollador de software? solo tienes que{" "}
                <Link
